...
public class RecordProcessor {
    ...
    private Dataset<Row> averageBetweenSubsequentRecords(Dataset<Row> records) {
        ...
        var recordsWithDiff = records.withColumn("diff", records.col("creation_time_local").cast(DataTypes.LongType).minus(functions.lag("creation_time_local", 1).over(Window.partitionBy("date_time").orderBy(records.col("creation_time_local").cast(DataTypes.LongType)))));
